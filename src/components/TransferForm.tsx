      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="border rounded p-2 mb-2 w-full"
          />
          <button className="bg-red-500 text-white px-4 py-2 rounded w-full" onClick={handleBurnSubmit}>
            Burn
          </button>
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="border rounded p-2 mb-2 w-full"
          />
          <button className="bg-green-500 text-white px-4 py-2 rounded w-full" onClick={handleMintSubmit}>
            Mint
          </button>
        </div>
      </div>
